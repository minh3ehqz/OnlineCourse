...
<html>
    ...
    <body>
        ...
        <div class="con">
            <form action="/Project_PRJ301/insertClServlet" method="post" class="i">
                <table>
                    <tr>
                        <td><label for="clID"><b>Class</b></label></td>
                        <td> <input name="clID" type="text"required></td>
                    </tr>
                    <tr>
                        <td><label for="de"><b>department</b></label></td>
                        <td class="hold"><input type="text"  name="de" required></td>
                    </tr>
                    <tr>
                        <td><label for="title"><b>Title</b></label></td>
                        <td class="hold"><input type="text"  name="title" required></td>

                    </tr>
                    <tr>
                        <td> <label for="images"><b>Images</b></label></td>
                        <td class="hold"><input type="text"  name="images"required></td>
                    </tr>
                </table>
                <button type="submit" class="btsub" formaction="/Project_PRJ301/insertClServlet">Thêm</button>
            </form>
        </div>
