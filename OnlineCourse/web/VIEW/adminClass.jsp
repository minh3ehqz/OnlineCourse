    ...
    <body>
        ...
        <div class="page depart" style="text-align: center">  
            ...
            <div  style="background-color: black;">
                <a href="/Project_PRJ301/ADclassServlet"style="color: white">class</a>
            </div>
            <div>
        ...
        <table class="table table-striped table-hover" style="margin-top: 10px;height: 65%;">
            <tr>
                <th colspan="6" style="text-align: center; background-color: black ; color: white" >Danh sách lớp</th>
            </tr>
            <tr>
                <th>classID</th>
                <th>DepartID</th>
            ...
            <c:forEach items="${listClass}" var="st">
                <tr>
                    <td>${st.ID}</td>
                    <td>${st.departID}</td>
                    <td>${st.title}</td>
                    <td>${st.images}</td>
                    <td><a href="UpdateClassServlet?id=${st.ID}">UPDATE</a></td>
                    <td><a href="ADclassServlet?type=2&id=${st.ID}">DELETE</a></td>
                </tr>
            </c:forEach>
        </table>
        ...
        <div class="page" style="text-align: center">
            <c:forEach begin="1" end="${endp}" var="i" >
                <div>
                    <a href="ADclassServlet?index=${i}">${i}</a>
                </div>
            </c:forEach>
        </div>
        <a class="insert" href="/Project_PRJ301/insertClServlet">Thêm lớp</a>
        <div id="footer">
